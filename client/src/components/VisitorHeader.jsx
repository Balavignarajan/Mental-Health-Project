        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-100">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <Link to="/" className="block px-3 py-2 text-mh-dark hover:text-mh-green font-medium" onClick={() => setIsMobileMenuOpen(false)}>
                Home
              </Link>
              <Link to="/about" className="block px-3 py-2 text-mh-dark hover:text-mh-green font-medium" onClick={() => setIsMobileMenuOpen(false)}>
                About Us
              </Link>
              <Link to="/assessments" className="block px-3 py-2 text-mh-dark hover:text-mh-green font-medium" onClick={() => setIsMobileMenuOpen(false)}>
                All Assessments
              </Link>
              <Link to="/testimonials" className="block px-3 py-2 text-mh-dark hover:text-mh-green font-medium" onClick={() => setIsMobileMenuOpen(false)}>
                Testimonials
              </Link>
              <Link to="/contact" className="block px-3 py-2 text-mh-dark hover:text-mh-green font-medium" onClick={() => setIsMobileMenuOpen(false)}>
                Contact Us
              </Link>
              <Link to="/login" className="block px-3 py-2 bg-mh-green text-mh-white rounded-lg font-medium mt-2 text-center" onClick={() => setIsMobileMenuOpen(false)}>
                Login
              </Link>
            </div>
          </div>
