        ...
        {activeTab === 'ongoing' ? (
          ...
          <>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
              <div className="flex items-start gap-4">
                <div className="relative flex-shrink-0">
                  <img src={f2} alt="Assessment" className="w-60 h-44 object-cover rounded-lg opacity-50" />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-20">
                    ...
                    <div className="flex gap-3">
                      <button className="border border-mh-green text-mh-green hover:bg-green-50 px-4 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-2">
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
              <div className="flex items-start gap-4">
                <div className="relative flex-shrink-0">
                  <img src={f1} alt="Assessment" className="w-60 h-44 object-cover rounded-lg opacity-50" />
                  <div className="absolute top-1.5 left-1.5 bg-mh-green text-white text-xs px-2 py-0.5 rounded-full">
                    Completed
                  </div>
                </div>
